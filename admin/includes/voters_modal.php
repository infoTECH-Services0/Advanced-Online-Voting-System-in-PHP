        ...
        <div class="modal-content" style="border-radius: 20px; box-shadow: 0 0 5px white; border: 3px ridge maroon">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="voters_add.php" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="Votersregno" class="col-sm-3 control-label">Student RegNo</label>

                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="voters_reg_no" name="voters_reg_no" required>
                    </div>
                </div>
        ...
        <div class="modal-content" style="border-radius: 20px; box-shadow: 0 0 5px white; border: 3px ridge maroon">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="voters_edit.php">
                ...
                <div class="form-group">
                    <label for="edit_Reg_No" class="col-sm-3 control-label">Registration No</label>

                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="edit_voters_reg_no" name="voters_reg_no">
                    </div>
                </div>

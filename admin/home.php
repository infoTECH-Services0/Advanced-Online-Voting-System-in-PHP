    ...
    <section class="content">
      ...
      <div class="row">
        ...
        <div class="col-xl-3 col-xs-6">
          <!-- small box -->
          <div class="small-box bg-red" style='box-shadow: 0 0 15px black;'>
            <div class="inner">
              <?php
        ...
        <div class="col-xl-3 col-xs-6">
          ...
          <div class="small-box bg-red" style='box-shadow: 0 0 15px black;'>
            <div class="inner">
              <?php
                $sql = "SELECT * FROM votes GROUP BY voters_reg_no";
                $query = $conn->query($sql);
        ...
        <!-------------------------------------------->
<!-------------------------------------------->
<!--  HIDDEN RESULTS PANEL AT HOME PAGE      -->
<!--
      <div class="row">
        <div class="col-xs-12">
          <h3> <b>VOTES TALLY</b>
      ...
      <?php
        ...
        while($row = $query->fetch_assoc()){
          ...
          echo "
            <div class='col-sm-6'>
              <div class='box box-solid' style='box-shadow: 0 0 2px black'>
